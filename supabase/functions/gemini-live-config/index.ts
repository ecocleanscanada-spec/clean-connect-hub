...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log("Authenticated user requesting live config:", userId);
    ...
    // Note: This is returned to authenticated clients only for WebSocket connection
    // as the Gemini Live API requires client-side WebSocket connection
    console.log("Providing live config to authenticated user:", userId);
    return new Response(
